...
/* HICR5 Bits */
#define HICR5_EN_SIOGIO BIT(31)		/* Enable SIOGIO */
#define HICR5_EN80HGIO BIT(30)		/* Enable 80hGIO */
...
#define HICR5_ENINT_SNP0W BIT(1)		/* Enable Snooping address 0 */
#define HICR5_EN_SNP0W BIT(0)			/* Enable Snooping address 0 */

/* HRCR6 Bits */
#define HICR6_STR_SNP0W BIT(0)	/* Interrupt Status Snoop address 0 */
#define HICR6_STR_SNP1W BIT(1)	/* Interrupt Status Snoop address 1 */

/* HICRB Bits */
#define HICRB_EN80HSGIO BIT(13)	/* Enable 80hSGIO */
